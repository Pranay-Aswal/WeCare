...
<div class="box">
  ...
  <h1 style="color: #644A10; margin-top: -320px; margin-left: 500px; text-align: center;  font-size: 32px; text-transform: uppercase;"><b><?= $row['Pet_Name']; ?></b></h1>
    <h2 style="color: #644A10; text-align: center; margin-left: 500px; font-size: 20px; margin-top: -10px;"><?= $row['Pet']; ?> - <?= $row['Breed']; ?></h2>
    <div class="info" >
      <p style="font-size: 18px;">Age : <?= $row['Age']; ?></p>
      <p style="font-size: 18px;">Gender : <?= $row['Gender']; ?></p>
      <p style="font-size: 18px;">Weight : <?= $row['Weight']; ?></p>
      <p style="font-size: 18px;">Vaccination : <?= $row['Vaccination']; ?></p>
    <p style="font-size: 18px;">Date of Lending : <?= $row['Date_of_Lending']; ?></p>
      <p style="font-size: 18px;">Date of Return : <?= $row['Date_of_Return']; ?></p></div>

       <div class="info1">
      
      <p style="font-size: 18px;">Phone Number : <?= $row['Phone_Number']; ?></p>
      <p style="font-size: 18px;">Address : <?= $row['Address']; ?></p>
      <p style="font-size: 18px;">Additional Info : <?= $row['Additional_Info']; ?></p></div>
      <div class="button" onclick= "document.location.href='index.php'">ADOPT THIS PET</div>
