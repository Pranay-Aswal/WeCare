  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
        <div class="lend-box">
          <h2 style="margin-left: 20px; ">LEND A PET</h2>
          <ul class="a" style="margin-top: 30px; margin-left: -70px; margin-right: 30px;" >
            <li style="font-size: 20px;">-> Let others take care of your pet while you're on a vacation</li>
           <li style="font-size: 20px;">-> Click the <b>LEND</b> button below and enter the details of your pet</li>
            <li style="font-size: 20px;">-> Please specify if your pet is allergic to any food or medicine in additional info section</li>
          </ul>
           <ul onclick="toggle()">
                <li>
                
                </li>
          <a href="javascript:void(0)" onclick="document.location.href='plend.php'" style="margin-top: 30px; margin-left: 90px;">LEND</a>
        </ul>
        </div>
      </div>
      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 padding_rl">
        <div class="lend-box_img">
          <figure><img src="images/lend.jpg" style="height: 490px;" alt="#" /></figure>
        </div>
      </div>
    </div>
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12" style="margin-left: 50%;">
        <div class="adopt-box">
          <h2 style="margin-left: 20px;">ADOPT A PET</h2>
          <ul class="a" style="margin-top: 30px; margin-right: 70px; margin-left: -30px;">
            <li style="font-size: 20px;">-> Help in taking care of other's pets</li>
           <li style="font-size: 20px;">-> Click the <b>ADOPT</b> button below and choose the pet you would like to take care of</li>
            <li style="font-size: 20px;">-> Please go through the pet details carefully before selecting</li>
          </ul>
          <a href="#" onclick="document.location.href='padopt.php'" style="margin-top: 30px; margin-left: 100px;">ADOPT</a>
        </div>
      </div>
      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 padding_rl" style="margin-left: 0.1px; margin-top: -31.1%; ">
        <div class="adopt-box_img">
          <figure><img src="images/adopt1.jpg" style="height: 460px; margin-top: -2.5px;"></figure>
        </div>
      </div>
    </div>
...
<div id="adopt" class="adopt">
  <div class="container-fluid">
    <div class="row">
      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
        <div class="adopt-box">
          <h2 style="margin-left: 30px;">PET CARE</h2>
           <ul class="a" style="margin-top: 30px; margin-left: -70px; margin-right: 30px;" >
            <li style="font-size: 20px;">-> Follow our pet caring tips as advised by experts</li>
           <li style="font-size: 20px;">-> Click the <b>TIPS</b> button below and follow the caring tips for your pet</li>
            <li style="font-size: 20px;">-> Watch the attached videos for any practical tips required for your pet</li>
          </ul>
          <a href="#" onclick="document.location.href='ptips.php'" style="margin-top: 30px; margin-left: 90px;">TIPS</a>
        </div>
      </div>
      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 padding_rl">
        <div class="adopt-box_img">
          <figure><img src="images/care.jpg" style="height: 450px;"></figure>
        </div>
      </div>
    </div>
...
<div id="adopt" class="adopt">
  <div class="container-fluid">
    <div class="row">
      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12" style="margin-left: 50%;">
        <div class="adopt-box">
          <h2 style="text-align: center; margin-left: 60px;">PET STORE</h2>
          <ul class="a" style="margin-top: 30px; margin-right: 70px; margin-left: -30px;">
            <li style="font-size: 20px;">-> Shop for your pet on WeCARE.com</li>
          ...
          <a href="#" onclick="document.location.href='pstore.php'" style="margin-top: 30px; margin-left: 100px;">SHOP NOW</a>
        </div>
      </div>
      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 padding_rl" style="margin-left: 0.1px; margin-top: -31.1%; ">
        <div class="adopt-box_img">
          <figure><img src="images/shop.jpg" style="height: 460px; margin-top: -2.5px;"></figure>
        </div>
      </div>
    </div>
